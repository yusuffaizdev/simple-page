                ...
                <div class="container">
                    ...
                    <form method="POST" action="{{ route('post.update', $post->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <input class="write-content-box" id="title" type="text" name="title"
                                    value="{{$post->title}}" required autocomplete="title" placeholder="Title" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <textarea class="write-content-box" id="description" name="description" required
                                          placeholder="Description" rows="4" cols="100">{{$post->description}}</textarea>
                            </div>
                        </div>
